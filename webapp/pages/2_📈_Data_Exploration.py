...
# webpage 02 - Data Exploration
# -----------------------------
# This page is used to explore the data and compare the data between stores
...
n = st.session_state.store # store name to explore
c = st.session_state.store_c # store to compare

dataExploration = st.container() # container for the data exploration
